# Task 02 — Create `.claude/workflow.md`

**Goal:** Separate the advocate loop, XML delegation templates, and delta re-delegation pattern.
...
```bash
grep -c "<task>\|<acceptance_criteria>\|<correction>" .claude/workflow.md
# Expected: 6 or more
```
