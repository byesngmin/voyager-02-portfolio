...
### 개인 경험
"전역 직후 자전거로 국토 종주를 결심" > "완주는 의지력이 아닌 리스크 관리 위에서 이루어짐" > "외딴 도로에서 자전거 고장 대처 프로세스 구축, 실제로 그 일이 일어남" > "고장시 공수 최소화 프로세스: 1)히치하이킹, 2) 가지고 있는 수리 키트로 자가 수리, 3) 자전거 끌고서라도 목적지로 이동, 4) 자전거 포기하고 도시로 나갈 방법 찾기" > "히치하이킹으로 자전거 수리점까지 이동"

### 기업협약 프로젝트
"비주얼노벨식 스토리 모드 구축을 위한 데이터테이블 필요" > "개발자와의 협업 효율을 위해 기획자가 의도한 연출을 테이블만으로 제어할 수 있도록 함이 필요" > "담장자에게 비주얼노벨 설명회 + 예시 구조 전달" > "개발자 피드백 수용하여 연출 제어까지 가능한 테이블 구조 완성"

### 학습매니저
"학습매니저가 매일 교강사에게 훈련일지 작성을 알람 지침" > "교강사의 반복업무 피로감 절감 목적" > "훈련일지 자동 작성 시스템 구축 및 교강사에게 알람까지 자동화" > "일당 교강사 업무 10~20분 절감"
